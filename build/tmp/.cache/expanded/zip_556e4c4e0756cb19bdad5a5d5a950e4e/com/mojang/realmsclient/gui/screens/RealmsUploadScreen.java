...
public class RealmsUploadScreen extends RealmsScreen implements RealmsWorldUploadStatusTracker {
    ...
    private void upload() {
        ...
        RealmsWorldOptions realmsworldoptions = RealmsWorldOptions.createFromSettings(this.selectedLevel.getSettings(), true, this.selectedLevel.levelVersion().minecraftVersionName());
