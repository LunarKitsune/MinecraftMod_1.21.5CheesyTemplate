...
public class RealmsCreateRealmScreen extends RealmsScreen {
    ...
    public RealmsCreateRealmScreen(RealmsMainScreen pLastScreen, RealmsServer pServer, boolean pIsSnapshor) {
        super(CREATE_REALM_TEXT);
        this.lastScreen = pLastScreen;
        this.createWorldRunnable = () -> this.createWorld(pServer, pIsSnapshor);
    }
