...
public class ForgeHooksClient {
    ...
    */
    ...
    private record WrapedModelBaker(ModelBaker parent, RenderTypeGroup group, RenderTypeGroup renderTypeFast) implements ModelBaker {
        ...
        @Override public ResolvedModel getModel(ResourceLocation pModelLocation) {
            return parent.getModel(pModelLocation);
        }
        ...
        @Override
        public <T> T compute(SharedOperationKey<T> pKey) {
            return parent.compute(pKey);
        }
    }
}
