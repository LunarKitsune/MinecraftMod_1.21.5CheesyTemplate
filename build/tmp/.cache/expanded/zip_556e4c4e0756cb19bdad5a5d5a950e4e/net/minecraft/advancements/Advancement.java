...
public record Advancement(
    ...
    public static class Builder {
        ...
        public Advancement.Builder display(
            ...
            return this.display(
                new DisplayInfo(
                    pIcon, pTitle, pDescription, Optional.ofNullable(pBackground).map(ClientAsset::new), pType, pShowToast, pAnnounceChat, pHidden
                )
            );
        }
        ...
        public Advancement.Builder display(
            ...
            return this.display(
                new DisplayInfo(
                    ...
                    pTitle,
                    pDescription,
                    Optional.ofNullable(pBackground).map(ClientAsset::new),
                    pType,
                    pShowToast,
                    pAnnounceChat,
                    pHidden
        ...
        public AdvancementHolder save(Consumer<AdvancementHolder> pOutput, String pId) {
            return save(pOutput, ResourceLocation.parse(pId));
        }
