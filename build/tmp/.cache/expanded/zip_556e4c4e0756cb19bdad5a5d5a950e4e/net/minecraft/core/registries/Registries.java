...
public class Registries {
    ...
    public static String elementsDirPath(ResourceKey<? extends Registry<?>> pRegistryKey) {
        if (!pRegistryKey.location().getNamespace().equals("minecraft"))
            return pRegistryKey.location().getNamespace() + '/' + pRegistryKey.location().getPath();
        return pRegistryKey.location().getPath();
    }

    public static String tagsDirPath(ResourceKey<? extends Registry<?>> pRegistryKey) {
        if (!pRegistryKey.location().getNamespace().equals("minecraft"))
            return "tags/" + pRegistryKey.location().getNamespace() + '/' + pRegistryKey.location().getPath();
