...
public final class DataComponentPatch {
    ...
    private static StreamCodec<RegistryFriendlyByteBuf, DataComponentPatch> createStreamCodec(final DataComponentPatch.CodecGetter pCodecGetter) {
        return new StreamCodec<RegistryFriendlyByteBuf, DataComponentPatch>() {
            public DataComponentPatch decode(RegistryFriendlyByteBuf p_394008_) {
                ...
                if (i == 0 && j == 0) {
                    ...
                    for (int l = 0; l < i; l++) {
                        ...
                        Object object = pCodecGetter.apply(datacomponenttype).decode(p_394008_);
            ...
            private <T> void encodeComponent(RegistryFriendlyByteBuf p_391817_, DataComponentType<T> p_392724_, Object p_397568_) {
                pCodecGetter.apply(p_392724_).encode(p_391817_, (T)p_397568_);
            }
        };
    }
    ...
    public boolean equals(Object pOther) {
        return this == pOther ? true : pOther instanceof DataComponentPatch datacomponentpatch && this.map.equals(datacomponentpatch.map);
    }
    ...
    interface CodecGetter {
        <T> StreamCodec<? super RegistryFriendlyByteBuf, T> apply(DataComponentType<T> pComponentType);
    }
