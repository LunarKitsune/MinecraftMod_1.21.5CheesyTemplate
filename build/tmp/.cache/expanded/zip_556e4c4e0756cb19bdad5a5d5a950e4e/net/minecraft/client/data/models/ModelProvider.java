...
public class ModelProvider implements DataProvider {
    ...
    public static class BlockStateGeneratorCollector implements Consumer<BlockModelDefinitionGenerator> {
        ...
        public CompletableFuture<?> save(CachedOutput pOutput, PackOutput.PathProvider pPathProvider) {
            ...
            Function<Block, Path> function = p_378541_ -> pPathProvider.json(p_378541_.builtInRegistryHolder().key().location());
            return DataProvider.saveAll(pOutput, BlockModelDefinition.CODEC, function, map);
        }
    }
    ...
    public static class SimpleModelCollector implements BiConsumer<ResourceLocation, ModelInstance> {
        ...
        public CompletableFuture<?> save(CachedOutput pOutput, PackOutput.PathProvider pPathProvider) {
            return DataProvider.saveAll(pOutput, Supplier::get, pPathProvider::json, this.models);
        }
    }
}
