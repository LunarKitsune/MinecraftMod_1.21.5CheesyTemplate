...
public class SpecialModelWrapper<T> implements ItemModel {
    ...
    public SpecialModelWrapper(SpecialModelRenderer<T> pSpecialRenderer, ModelRenderProperties pProperties) {
    ...
    public record Unbaked(ResourceLocation base, SpecialModelRenderer.Unbaked specialModel) implements ItemModel.Unbaked {
        ...
        private ModelRenderProperties getProperties(ItemModel.BakingContext pContext) {
            ModelBaker modelbaker = pContext.blockModelBaker();
