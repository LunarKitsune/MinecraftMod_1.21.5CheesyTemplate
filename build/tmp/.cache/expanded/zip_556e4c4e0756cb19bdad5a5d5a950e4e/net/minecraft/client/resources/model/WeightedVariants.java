...
public class WeightedVariants implements BlockStateModel {
    ...
    public WeightedVariants(WeightedList<BlockStateModel> pList) {
        this.list = pList;
        this.firstModel = pList.unwrap().getFirst().value();
    ...
    @Override
    public void collectParts(RandomSource random, List<BlockModelPart> dest, net.minecraftforge.client.model.data.ModelData data, net.minecraft.client.renderer.RenderType renderType) {
