...
public class ModelLayers {
    ...
    public static ModelLayerLocation createStandingSignModelName(WoodType pWoodType) {
        ResourceLocation location = ResourceLocation.parse(pWoodType.name());
    ...
    public static ModelLayerLocation createHangingSignModelName(WoodType pWoodType, HangingSignRenderer.AttachmentType pAttachmentType) {
        ResourceLocation location = ResourceLocation.parse(pWoodType.name());
        return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(location.getNamespace(), "hanging_sign/" + location.getPath() + "/" + pAttachmentType.getSerializedName()), "main");
    }
