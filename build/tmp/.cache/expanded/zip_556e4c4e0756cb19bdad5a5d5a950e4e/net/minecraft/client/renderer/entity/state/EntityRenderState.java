...
public class EntityRenderState {
    ...
    public void fillCrashReportCategory(CrashReportCategory pCrashReportCategory) {
        pCrashReportCategory.setDetail("EntityRenderState", this.getClass().getCanonicalName());
        pCrashReportCategory.setDetail("Entity's Exact location", String.format(Locale.ROOT, "%.2f, %.2f, %.2f", this.x, this.y, this.z));
    }
