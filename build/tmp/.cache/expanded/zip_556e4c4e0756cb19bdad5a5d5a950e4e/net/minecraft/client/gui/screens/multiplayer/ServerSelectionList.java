...
public class ServerSelectionList extends ObjectSelectionList<ServerSelectionList.Entry> {
    ...
    public class OnlineServerEntry extends ServerSelectionList.Entry {
        ...
        @Override
        public boolean mouseClicked(double pMouseX, double pMouseY, int pButton) {
            double d0 = pMouseX - ServerSelectionList.this.getRowLeft();
            double d1 = pMouseY - ServerSelectionList.this.getRowTop(ServerSelectionList.this.children().indexOf(this));
            if (d0 <= 32.0) {
