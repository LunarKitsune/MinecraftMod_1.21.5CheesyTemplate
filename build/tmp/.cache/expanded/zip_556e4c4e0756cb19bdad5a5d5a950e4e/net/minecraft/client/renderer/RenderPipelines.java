...
public class RenderPipelines {
    ...
    public static final RenderPipeline.Snippet MATRICES_COLOR_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET).withUniform("ColorModulator", UniformType.VEC4).buildSnippet();
    ...
    public static final RenderPipeline.Snippet MATRICES_COLOR_FOG_OFFSET_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withUniform("ModelOffset", UniformType.VEC3).buildSnippet();
    ...
    public static final RenderPipeline.Snippet ENTITY_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET)
        ...
        .buildSnippet();
    public static final RenderPipeline.Snippet BEACON_BEAM_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET)
    ...
    public static final RenderPipeline.Snippet TEXT_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
        ...
        .buildSnippet();
    public static final RenderPipeline.Snippet END_PORTAL_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET, FOG_SNIPPET)
        ...
        .buildSnippet();
    public static final RenderPipeline.Snippet CLOUDS_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_OFFSET_SNIPPET)
        .withVertexShader("core/rendertype_clouds")
        .withFragmentShader("core/rendertype_clouds")
        .withBlend(BlendFunction.TRANSLUCENT)
        .withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS)
        .buildSnippet();
    public static final RenderPipeline.Snippet LINES_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET)
        ...
        .buildSnippet();
    public static final RenderPipeline.Snippet DEBUG_FILLED_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
    ...
    public static final RenderPipeline.Snippet GUI_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
        ...
        .withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS)
        .buildSnippet();
    public static final RenderPipeline.Snippet GUI_TEXTURED_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
        ...
        .buildSnippet();
    public static final RenderPipeline.Snippet OUTLINE_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
    ...
    public static final RenderPipeline DEBUG_SECTION_QUADS = register(RenderPipeline.builder(DEBUG_FILLED_SNIPPET).withLocation("pipeline/debug_section_quads").build());
    ...
    public static final RenderPipeline GUI_OVERLAY = register(
        RenderPipeline.builder(GUI_SNIPPET)
            .withLocation("pipeline/gui_overlay")
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
            .withDepthWrite(false)
            .build()
    );
    ...
    private static RenderPipeline register(RenderPipeline pPipeline) {
        PIPELINES_BY_LOCATION.put(pPipeline.getLocation(), pPipeline);
        return pPipeline;
    }
