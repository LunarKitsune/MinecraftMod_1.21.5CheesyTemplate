...
public class TestInstanceRenderer implements BlockEntityRenderer<TestInstanceBlockEntity> {
    ...
    public TestInstanceRenderer(BlockEntityRendererProvider.Context pContext) {
        this.beacon = new BeaconRenderer<>(pContext);
        this.box = new BlockEntityWithBoundingBoxRenderer<>(pContext);
    }
