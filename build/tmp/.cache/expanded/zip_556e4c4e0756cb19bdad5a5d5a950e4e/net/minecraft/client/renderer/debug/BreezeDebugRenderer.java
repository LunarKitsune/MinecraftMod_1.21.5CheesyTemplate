...
public class BreezeDebugRenderer {
            ...
            .forEach(
                p_389510_ -> {
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::attackTarget)
                        ...
                        .ifPresent(
                            p_310972_ -> {
                                drawLine(pPoseStack, pBuffer, pXOffset, pYOffset, pZOffset, p_389510_.position(), p_310972_, TARGET_LINE_COLOR);
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::jumpTarget)
                        .ifPresent(
                            p_374651_ -> {
                                drawLine(pPoseStack, pBuffer, pXOffset, pYOffset, pZOffset, p_389510_.position(), p_374651_.getCenter(), JUMP_TARGET_LINE_COLOR);
    ...
    private static void drawCircleVertex(
        ...
        float f = pIndex * (float) (Math.PI / 10);
        Vec3 vec3 = pCircleCenter.add(pRadius * Math.cos(f), 0.0, pRadius * Math.sin(f));
