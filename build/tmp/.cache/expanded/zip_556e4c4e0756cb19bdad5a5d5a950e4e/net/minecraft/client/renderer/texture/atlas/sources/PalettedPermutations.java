...
public record PalettedPermutations(List<ResourceLocation> textures, ResourceLocation paletteKey, Map<String, ResourceLocation> permutations, String separator)
    ...
    public PalettedPermutations(List<ResourceLocation> pTextures, ResourceLocation pPaletteKey, Map<String, ResourceLocation> pPermutations) {
        this(pTextures, pPaletteKey, pPermutations, "_");
    }
