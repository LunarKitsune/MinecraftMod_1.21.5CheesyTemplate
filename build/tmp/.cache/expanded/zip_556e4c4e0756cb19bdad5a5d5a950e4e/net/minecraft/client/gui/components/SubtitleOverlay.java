            ...
            if (!this.audibleSubtitles.isEmpty()) {
                ...
                for (SubtitleOverlay.Subtitle subtitleoverlay$subtitle2 : this.audibleSubtitles) {
                    ...
                    if (subtitleoverlay$soundplayedat != null) {
                        ...
                        pGuiGraphics.pose().translate(pGuiGraphics.guiWidth() - j * 1.0F - 2.0F, pGuiGraphics.guiHeight() - 35 - l1 * (k + 1) * 1.0F, 0.0F);
    ...
    static class Subtitle {
        ...
        public boolean isAudibleFrom(Vec3 pLocation) {
            if (Float.isInfinite(this.range)) {
                ...
                return subtitleoverlay$soundplayedat == null ? false : pLocation.closerThan(subtitleoverlay$soundplayedat.location, this.range);
            }
        }

        public void purgeOldInstances(double pDisplayTime) {
            long i = Util.getMillis();
            this.playedAt.removeIf(p_342900_ -> i - p_342900_.time() > pDisplayTime);
        }
