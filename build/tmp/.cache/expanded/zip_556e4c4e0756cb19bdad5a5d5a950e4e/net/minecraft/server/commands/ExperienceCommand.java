...
public class ExperienceCommand {
    ...
    static enum Type {
        POINTS("points", Player::giveExperiencePoints, (p_390010_, p_390011_) -> {
            if (p_390011_ >= p_390010_.getXpNeededForNextLevel()) {
                return false;
            } else {
                p_390010_.setExperiencePoints(p_390011_);
                return true;
            }
        }, p_390012_ -> Mth.floor(p_390012_.experienceProgress * p_390012_.getXpNeededForNextLevel())),
