...
public class SpreadPlayersCommand {
    ...
    private static int spreadPlayers(
        ...
        if (pMaxHeight < i) {
            ...
            double d0 = pCenter.x - pMaxRange;
            double d1 = pCenter.y - pMaxRange;
            double d2 = pCenter.x + pMaxRange;
            double d3 = pCenter.y + pMaxRange;
            ...
            spreadPositions(pCenter, pSpreadDistance, serverlevel, randomsource, d0, d1, d2, d3, pMaxHeight, aspreadplayerscommand$position, pRespectTeams);
    ...
    private static double setPlayerPositions(
        ...
        return pTargets.size() < 2 ? 0.0 : d0 / pTargets.size();
    }
