...
public class OverworldBiomes {
    ...
    private static Biome biome(
        ...
        return biome(pHasPercipitation, pTemperature, pDownfall, 4159204, 329011, null, null, null, pMobSpawnSettings, pGenerationSettings, pBackgroundMusic);
    }
    ...
    private static Biome biome(
        ...
        if (pDryFoliageColorOverride != null) {
            biomespecialeffects$builder.dryFoliageColorOverride(pDryFoliageColorOverride);
        }

        return new Biome.BiomeBuilder()
            .hasPrecipitation(pHasPercipitation)
    ...
    public static Biome oldGrowthTaiga(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsSpruce) {
        ...
        biomegenerationsettings$builder.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION, pIsSpruce ? VegetationPlacements.TREES_OLD_GROWTH_SPRUCE_TAIGA : VegetationPlacements.TREES_OLD_GROWTH_PINE_TAIGA
        );
    ...
    private static Biome baseJungle(
        ...
        float pDownfall,
        boolean pIsBambooJungle,
        boolean pIsSparse,
        boolean pAddBamboo,
        MobSpawnSettings.Builder pMobSpawnSettings,
        Music pBackgroudMusic
    ) {
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(pPlacedFeatures, pWorldCarvers);
        globalOverworldGeneration(biomegenerationsettings$builder);
        BiomeDefaultFeatures.addDefaultOres(biomegenerationsettings$builder);
    ...
    public static Biome plains(
        HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsSunflowerPlains, boolean pIsCold, boolean pIsIceSpikes
    ) {
        MobSpawnSettings.Builder mobspawnsettings$builder = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(pPlacedFeatures, pWorldCarvers);
        globalOverworldGeneration(biomegenerationsettings$builder);
    ...
    private static Biome baseOcean(MobSpawnSettings.Builder pMobSpawnSettings, int pWaterColor, int pWaterFogColor, BiomeGenerationSettings.Builder pGenerationSettings) {
        return biome(true, 0.5F, 0.5F, pWaterColor, pWaterFogColor, null, null, null, pMobSpawnSettings, pGenerationSettings, NORMAL_MUSIC);
    }
    ...
    public static Biome coldOcean(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsDeep) {
        ...
        biomegenerationsettings$builder.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION, pIsDeep ? AquaticPlacements.SEAGRASS_DEEP_COLD : AquaticPlacements.SEAGRASS_COLD
        );
    ...
    public static Biome ocean(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsDeep) {
        ...
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = baseOceanGeneration(pPlacedFeatures, pWorldCarvers);
        biomegenerationsettings$builder.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION, pIsDeep ? AquaticPlacements.SEAGRASS_DEEP : AquaticPlacements.SEAGRASS_NORMAL
        );
        BiomeDefaultFeatures.addColdOceanExtraVegetation(biomegenerationsettings$builder);
    ...
    public static Biome lukeWarmOcean(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsDeep) {
        ...
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = baseOceanGeneration(pPlacedFeatures, pWorldCarvers);
        biomegenerationsettings$builder.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION, pIsDeep ? AquaticPlacements.SEAGRASS_DEEP_WARM : AquaticPlacements.SEAGRASS_WARM
        );
    ...
    public static Biome forest(
        HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsBirchForest, boolean pTallBirchTrees, boolean pIsFlowerForest
    ) {
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(pPlacedFeatures, pWorldCarvers);
        globalOverworldGeneration(biomegenerationsettings$builder);
        Music music;
    ...
    public static Biome darkForest(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsPaleGarden) {
        MobSpawnSettings.Builder mobspawnsettings$builder = new MobSpawnSettings.Builder();
        if (!pIsPaleGarden) {
            BiomeDefaultFeatures.farmAnimals(mobspawnsettings$builder);
        }
        ...
        globalOverworldGeneration(biomegenerationsettings$builder);
        biomegenerationsettings$builder.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION, pIsPaleGarden ? VegetationPlacements.PALE_GARDEN_VEGETATION : VegetationPlacements.DARK_FOREST_VEGETATION
        );
        if (!pIsPaleGarden) {
            BiomeDefaultFeatures.addForestFlowers(biomegenerationsettings$builder);
        } else {
    ...
    public static Biome swamp(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers) {
        ...
        mobspawnsettings$builder.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1));
        mobspawnsettings$builder.addSpawn(MobCategory.MONSTER, 30, new MobSpawnSettings.SpawnerData(EntityType.BOGGED, 4, 4));
        mobspawnsettings$builder.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.FROG, 2, 5));
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(pPlacedFeatures, pWorldCarvers);
        BiomeDefaultFeatures.addFossilDecoration(biomegenerationsettings$builder);
        globalOverworldGeneration(biomegenerationsettings$builder);
        BiomeDefaultFeatures.addDefaultOres(biomegenerationsettings$builder);
    ...
    public static Biome river(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsCold) {
        ...
        BiomeDefaultFeatures.commonSpawns(mobspawnsettings$builder);
        mobspawnsettings$builder.addSpawn(MobCategory.MONSTER, pIsCold ? 1 : 100, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 1, 1));
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(pPlacedFeatures, pWorldCarvers);
        globalOverworldGeneration(biomegenerationsettings$builder);
        BiomeDefaultFeatures.addDefaultOres(biomegenerationsettings$builder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomegenerationsettings$builder);
        ...
        return biome(
            true, f, 0.5F, pIsCold ? 3750089 : 4159204, 329011, null, null, null, mobspawnsettings$builder, biomegenerationsettings$builder, NORMAL_MUSIC
        );
    }
    ...
    public static Biome meadowOrCherryGrove(HolderGetter<PlacedFeature> pPlacedFeatures, HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers, boolean pIsCherryGrove) {
        ...
        mobspawnsettings$builder.addSpawn(
                MobCategory.CREATURE, 1, new MobSpawnSettings.SpawnerData(pIsCherryGrove ? EntityType.PIG : EntityType.DONKEY, 1, 2)
            )
        ...
        return pIsCherryGrove
            ? biome(true, 0.5F, 0.8F, 6141935, 6141935, 11983713, 11983713, null, mobspawnsettings$builder, biomegenerationsettings$builder, music)
            : biome(true, 0.5F, 0.8F, 937679, 329011, null, null, null, mobspawnsettings$builder, biomegenerationsettings$builder, music);
    }
