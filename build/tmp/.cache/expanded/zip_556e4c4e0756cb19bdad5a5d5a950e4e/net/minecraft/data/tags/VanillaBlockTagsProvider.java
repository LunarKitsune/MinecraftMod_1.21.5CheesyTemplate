...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider p_255662_) {
        ...
        this.tag(BlockTags.MOB_INTERACTABLE_DOORS)
            ...
            .add(
                Blocks.COPPER_DOOR, Blocks.EXPOSED_COPPER_DOOR, Blocks.WEATHERED_COPPER_DOOR, Blocks.OXIDIZED_COPPER_DOOR, Blocks.WAXED_COPPER_DOOR, Blocks.WAXED_EXPOSED_COPPER_DOOR, Blocks.WAXED_WEATHERED_COPPER_DOOR, Blocks.WAXED_OXIDIZED_COPPER_DOOR
            );
        ...
        this.tag(BlockTags.SMALL_FLOWERS).add(ablock).add(Blocks.CLOSED_EYEBLOSSOM);
        ...
        this.tag(BlockTags.FLOWERS).addTag(BlockTags.SMALL_FLOWERS).add(ablock1);
        this.tag(BlockTags.BEE_ATTRACTIVE).add(ablock).add(ablock1);
        ...
        this.tag(BlockTags.INSIDE_STEP_SOUND_BLOCKS)
            .add(
                Blocks.POWDER_SNOW, Blocks.SCULK_VEIN, Blocks.GLOW_LICHEN, Blocks.LILY_PAD, Blocks.SMALL_AMETHYST_BUD, Blocks.PINK_PETALS, Blocks.WILDFLOWERS, Blocks.LEAF_LITTER
            );
        ...
        this.tag(BlockTags.BADLANDS_TERRACOTTA)
            ...
            .add(Blocks.WHITE_TERRACOTTA, Blocks.YELLOW_TERRACOTTA, Blocks.ORANGE_TERRACOTTA, Blocks.RED_TERRACOTTA, Blocks.BROWN_TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA);
        ...
        this.tag(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)
            .add(
                Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS, Blocks.MANGROVE_ROOTS, Blocks.MANGROVE_LEAVES, Blocks.MANGROVE_LOG, Blocks.MANGROVE_PROPAGULE, Blocks.MOSS_CARPET, Blocks.VINE
            );
        ...
        this.tag(BlockTags.REPLACEABLE_BY_MUSHROOMS)
            ...
            .add(
                Blocks.WARPED_ROOTS, Blocks.NETHER_SPROUTS, Blocks.CRIMSON_ROOTS, Blocks.LEAF_LITTER, Blocks.SHORT_DRY_GRASS, Blocks.TALL_DRY_GRASS, Blocks.BUSH, Blocks.FIREFLY_BUSH
            );
        ...
        p_255662_.lookupOrThrow(Registries.BLOCK).filterElements(p_358469_ -> p_358469_.defaultBlockState().canBeReplaced()).listElementIds().forEach(intrinsictagappender::add);
