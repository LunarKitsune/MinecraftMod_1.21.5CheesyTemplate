...
public class BiomeTagsProvider extends TagsProvider<Biome> {
    public BiomeTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pProvider) {
        super(pOutput, Registries.BIOME, pProvider);
    }

    public BiomeTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pProvider, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
        super(pOutput, Registries.BIOME, pProvider, modId, existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.Provider p_256485_) {
        ...
        TagsProvider.TagAppender<Biome> tagappender2 = this.tag(BiomeTags.HAS_TRIAL_CHAMBERS);
        MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD.usedBiomes().filter(Predicate.not(Biomes.DEEP_DARK::equals)).forEach(tagappender2::add);
