...
public class ExtraCodecs {
    ...
    public static final Codec<Integer> NON_NEGATIVE_INT = intRangeWithMessage(0, Integer.MAX_VALUE, p_274847_ -> "Value must be non-negative: " + p_274847_);
    public static final Codec<Integer> POSITIVE_INT = intRangeWithMessage(1, Integer.MAX_VALUE, p_395838_ -> "Value must be positive: " + p_395838_);
    public static final Codec<Float> NON_NEGATIVE_FLOAT = floatRangeMinInclusiveWithMessage(0.0F, Float.MAX_VALUE, p_368583_ -> "Value must be non-negative: " + p_368583_);
    public static final Codec<Float> POSITIVE_FLOAT = floatRangeMinExclusiveWithMessage(0.0F, Float.MAX_VALUE, p_392346_ -> "Value must be positive: " + p_392346_);
    ...
    @Deprecated
    public static <E extends Enum<E>> Codec<E> legacyEnum(Function<String, E> pFromString) {
        return Codec.STRING.comapFlatMap(p_390207_ -> {
            try {
                return DataResult.success(pFromString.apply(p_390207_));
            } catch (IllegalArgumentException illegalargumentexception) {
