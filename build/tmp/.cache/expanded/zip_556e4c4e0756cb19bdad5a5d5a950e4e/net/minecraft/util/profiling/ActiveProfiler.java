...
public class ActiveProfiler implements ProfileCollector {
    ...
    public ActiveProfiler(LongSupplier pGetRealTime, IntSupplier pGetTickTime, BooleanSupplier pSupressWarnings) {
        this.startTimeNano = pGetRealTime.getAsLong();
        this.getRealTime = pGetRealTime;
        this.startTimeTicks = pGetTickTime.getAsInt();
        this.getTickTime = pGetTickTime;
        this.suppressWarnings = pSupressWarnings;
    }
