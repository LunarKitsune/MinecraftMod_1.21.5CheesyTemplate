...
public class V99 extends Schema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(map, "Arrow", p_18295_ -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(pSchema)));
        pSchema.register(map, "TippedArrow", p_18292_ -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(pSchema)));
        pSchema.register(map, "SpectralArrow", p_397789_ -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(pSchema)));
        ...
        pSchema.register(
            ...
            () -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(pSchema), "LastOutput", References.TEXT_COMPONENT.in(pSchema))
        );
        pSchema.registerSimple(map, "ArmorStand");
        pSchema.registerSimple(map, "Creeper");
        pSchema.registerSimple(map, "Skeleton");
        pSchema.registerSimple(map, "Spider");
        pSchema.registerSimple(map, "Giant");
        pSchema.registerSimple(map, "Zombie");
        pSchema.registerSimple(map, "Slime");
        pSchema.registerSimple(map, "Ghast");
        pSchema.registerSimple(map, "PigZombie");
        pSchema.register(map, "Enderman", p_18298_ -> DSL.optionalFields("carried", References.BLOCK_NAME.in(pSchema)));
        pSchema.registerSimple(map, "CaveSpider");
        pSchema.registerSimple(map, "Silverfish");
        pSchema.registerSimple(map, "Blaze");
        pSchema.registerSimple(map, "LavaSlime");
        pSchema.registerSimple(map, "EnderDragon");
        pSchema.registerSimple(map, "WitherBoss");
        pSchema.registerSimple(map, "Bat");
        pSchema.registerSimple(map, "Witch");
        pSchema.registerSimple(map, "Endermite");
        pSchema.registerSimple(map, "Guardian");
        pSchema.registerSimple(map, "Pig");
        pSchema.registerSimple(map, "Sheep");
        pSchema.registerSimple(map, "Cow");
        pSchema.registerSimple(map, "Chicken");
        pSchema.registerSimple(map, "Squid");
        pSchema.registerSimple(map, "Wolf");
        pSchema.registerSimple(map, "MushroomCow");
        pSchema.registerSimple(map, "SnowMan");
        pSchema.registerSimple(map, "Ozelot");
        pSchema.registerSimple(map, "VillagerGolem");
        pSchema.register(
            map,
            "EntityHorse",
        ...
        pSchema.registerSimple(map, "Rabbit");
        pSchema.register(
            map,
            "Villager",
        ...
        pSchema.registerSimple(map, "Shulker");
        return map;
    }
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema pSchema) {
        ...
        pSchema.register(map, "Sign", () -> sign(pSchema));
        ...
        pSchema.register(map, "Control", () -> DSL.optionalFields("LastOutput", References.TEXT_COMPONENT.in(pSchema)));
        pSchema.registerSimple(map, "Beacon");
        pSchema.register(map, "Skull", () -> DSL.optionalFields("custom_name", References.TEXT_COMPONENT.in(pSchema)));
        ...
        pSchema.register(map, "Banner", () -> DSL.optionalFields("CustomName", References.TEXT_COMPONENT.in(pSchema)));
    ...
    public static TypeTemplate sign(Schema pSchema) {
        return DSL.optionalFields(
            Pair.of("Text1", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("Text2", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("Text3", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("Text4", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("FilteredText1", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("FilteredText2", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("FilteredText3", References.TEXT_COMPONENT.in(pSchema)),
            Pair.of("FilteredText4", References.TEXT_COMPONENT.in(pSchema))
        );
    }
    ...
    public void registerTypes(Schema pSchema, Map<String, Supplier<TypeTemplate>> pEntityTypes, Map<String, Supplier<TypeTemplate>> pBlockEntityTypes) {
        pSchema.registerType(
            false,
            References.LEVEL,
            () -> DSL.optionalFields("CustomBossEvents", DSL.compoundList(DSL.optionalFields("Name", References.TEXT_COMPONENT.in(pSchema))))
        );
        pSchema.registerType(
            false,
            References.PLAYER,
        ...
        pSchema.registerType(
            ...
            () -> DSL.and(
                ...
                DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", DSL.string(), pEntityTypes))
            )
        );
        pSchema.registerType(
            true,
            ...
            () -> DSL.hook(
                DSL.optionalFields("id", DSL.or(DSL.constType(DSL.intType()), References.ITEM_NAME.in(pSchema)), "tag", itemStackTag(pSchema)),
                ADD_NAMES,
        ...
        pSchema.registerType(
            false, References.SAVED_DATA_MAP_DATA, () -> DSL.optionalFields("banners", DSL.list(DSL.optionalFields("Name", References.TEXT_COMPONENT.in(pSchema))))
        );
        ...
        pSchema.registerType(true, References.ENTITY_EQUIPMENT, () -> DSL.optional(DSL.field("Equipment", DSL.list(References.ITEM_STACK.in(pSchema)))));
    }

    public static TypeTemplate itemStackTag(Schema pSchema) {
        return DSL.optionalFields(
            ...
            Pair.of("pages", DSL.list(References.TEXT_COMPONENT.in(pSchema))),
            Pair.of("filtered_pages", DSL.compoundList(References.TEXT_COMPONENT.in(pSchema))),
            Pair.of("display", DSL.optionalFields("Name", References.TEXT_COMPONENT.in(pSchema), "Lore", DSL.list(References.TEXT_COMPONENT.in(pSchema))))
        );
    }
