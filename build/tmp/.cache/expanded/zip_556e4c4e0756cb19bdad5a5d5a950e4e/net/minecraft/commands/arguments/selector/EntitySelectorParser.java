...
public class EntitySelectorParser {
    ...
    public static <S> boolean allowSelectors(S pSuggestionProvider) {
        return pSuggestionProvider instanceof SharedSuggestionProvider sharedsuggestionprovider && sharedsuggestionprovider.hasPermission(2);
    }
    ...
    private Predicate<Entity> createRotationPredicate(WrappedMinMaxBounds pAngleBounds, ToDoubleFunction<Entity> pAngleFunction) {
        double d0 = Mth.wrapDegrees(pAngleBounds.min() == null ? 0.0F : pAngleBounds.min());
        double d1 = Mth.wrapDegrees(pAngleBounds.max() == null ? 359.0F : pAngleBounds.max());
        return p_175137_ -> {
