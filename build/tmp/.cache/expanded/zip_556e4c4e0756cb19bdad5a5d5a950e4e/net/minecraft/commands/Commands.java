...
public class Commands {
    ...
    public Commands(Commands.CommandSelection pSelection, CommandBuildContext pContext) {
        ...
        TestCommand.register(this.dispatcher, pContext);
    ...
    public void performCommand(ParseResults<CommandSourceStack> pParseResults, String pCommand) {
        ...
        try {
            var event = new net.minecraftforge.event.CommandEvent(pParseResults);
            ...
            ContextChain<CommandSourceStack> contextchain = finishParsing(event.getParseResults(), pCommand, commandsourcestack);
        ...
        try {
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
                ...
                MutableComponent mutablecomponent = Component.empty()
                    ...
                    .withStyle(p_389640_ -> p_389640_.withClickEvent(new ClickEvent.SuggestCommand("/" + pCommand)));
                if (i > 10) {
