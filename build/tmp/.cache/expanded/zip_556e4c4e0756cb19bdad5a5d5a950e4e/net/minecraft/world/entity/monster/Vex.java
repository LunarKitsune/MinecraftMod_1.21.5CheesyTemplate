...
public class Vex extends Monster implements TraceableEntity {
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.getInt("life_ticks").ifPresentOrElse(this::setLimitedLife, () -> this.hasLimitedLife = false);
    }
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.storeNullable("bound_pos", BlockPos.CODEC, this.boundOrigin);
        if (this.hasLimitedLife) {
            pCompound.putInt("life_ticks", this.limitedLifeTicks);
        }
    }
    ...
    @Nullable
    @Override
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_34002_, DifficultyInstance p_34003_, EntitySpawnReason p_366057_, @Nullable SpawnGroupData p_34005_) {
        ...
        return super.finalizeSpawn(p_34002_, p_34003_, p_366057_, p_34005_);
    }
        ...
        public void tick() {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                if (Vex.this.level().isEmptyBlock(blockpos1)) {
                    Vex.this.moveControl.setWantedPosition(blockpos1.getX() + 0.5, blockpos1.getY() + 0.5, blockpos1.getZ() + 0.5, 0.25);
                    if (Vex.this.getTarget() == null) {
                        Vex.this.getLookControl().setLookAt(blockpos1.getX() + 0.5, blockpos1.getY() + 0.5, blockpos1.getZ() + 0.5, 180.0F, 20.0F);
                    }
                    break;
                }
            }
