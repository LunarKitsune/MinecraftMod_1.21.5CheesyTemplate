...
public class ShulkerBullet extends Projectile {
    ...
    protected void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.storeNullable("Dir", Direction.LEGACY_ID_CODEC, this.currentMoveDirection);
    ...
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.targetDeltaX = pCompound.getDoubleOr("TXD", 0.0);
        this.targetDeltaY = pCompound.getDoubleOr("TYD", 0.0);
        this.targetDeltaZ = pCompound.getDoubleOr("TZD", 0.0);
        this.currentMoveDirection = pCompound.read("Dir", Direction.LEGACY_ID_CODEC).orElse(null);
