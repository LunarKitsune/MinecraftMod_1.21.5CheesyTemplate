...
public class Llama extends AbstractChestedHorse implements RangedAttackMob {
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.store("Variant", Llama.Variant.LEGACY_CODEC, this.getVariant());
        pCompound.putInt("Strength", this.getStrength());
    }

    @Override
    public void readAdditionalSaveData(CompoundTag pCompound) {
        this.setStrength(pCompound.getIntOr("Strength", 0));
        super.readAdditionalSaveData(pCompound);
        this.setVariant(pCompound.read("Variant", Llama.Variant.LEGACY_CODEC).orElse(Llama.Variant.DEFAULT));
    }
    ...
    private void setVariant(Llama.Variant pVariant) {
    ...
    static class LlamaAttackWolfGoal extends NearestAttackableTargetGoal<Wolf> {
        public LlamaAttackWolfGoal(Llama pLlama) {
            super(pLlama, Wolf.class, 16, false, true, (p_390667_, p_390668_) -> !((Wolf)p_390667_).isTame());
        }
