...
public class PrimedTnt extends Entity implements TraceableEntity {
    ...
    protected void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.store("block_state", BlockState.CODEC, registryops, this.getBlockState());
    ...
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        RegistryOps<Tag> registryops = this.registryAccess().createSerializationContext(NbtOps.INSTANCE);
        this.setFuse(pCompound.getShortOr("fuse", (short)80));
        this.setBlockState(pCompound.read("block_state", BlockState.CODEC, registryops).orElse(DEFAULT_BLOCK_STATE));
        this.explosionPower = Mth.clamp(pCompound.getFloatOr("explosion_power", 4.0F), 0.0F, 128.0F);
    }
