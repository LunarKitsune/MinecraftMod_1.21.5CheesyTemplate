...
public class Panda extends Animal {
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.store("MainGene", Panda.Gene.CODEC, this.getMainGene());
        pCompound.store("HiddenGene", Panda.Gene.CODEC, this.getHiddenGene());
    }

    @Override
    public void readAdditionalSaveData(CompoundTag pCompound) {
        super.readAdditionalSaveData(pCompound);
        this.setMainGene(pCompound.read("MainGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
        this.setHiddenGene(pCompound.read("HiddenGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
    }
    ...
    private static boolean canPickUpAndEat(ItemEntity pItemEntity) {
        return pItemEntity.getItem().is(ItemTags.PANDA_EATS_FROM_GROUND) && pItemEntity.isAlive() && !pItemEntity.hasPickUpDelay();
    }
