    ...
    public static <E extends Mob> OneShot<E> create(MemoryModuleType<BlockPos> pLocationMemory, int pCloseEnoughDist, float pSpeedModifier) {
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                ...
                .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_374989_, p_374990_, p_374991_) -> {
                    BlockPos blockpos = p_259997_.get(p_259831_);
                    boolean flag = blockpos.closerThan(p_374990_.blockPosition(), pCloseEnoughDist);
                    if (!flag) {
                        BehaviorUtils.setWalkAndLookTargetMemories(p_374990_, getNearbyPos(p_374990_, blockpos), pSpeedModifier, pCloseEnoughDist);
                    }
