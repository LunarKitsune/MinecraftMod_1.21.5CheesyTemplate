...
public class SpawnPlacements {
    ...
    public static <T extends Entity> boolean checkSpawnRules(
        ...
        SpawnPlacements.Data spawnplacements$data = DATA_BY_TYPE.get(pEntityType);
        boolean vanillaResult = spawnplacements$data == null || spawnplacements$data.predicate.test((EntityType)pEntityType, pLevel, pSpawnReason, pPos, pRandom);
        return net.minecraftforge.event.ForgeEventFactory.checkSpawnPlacements(pEntityType, pLevel, pSpawnReason, pPos, pRandom, vanillaResult);
    }
