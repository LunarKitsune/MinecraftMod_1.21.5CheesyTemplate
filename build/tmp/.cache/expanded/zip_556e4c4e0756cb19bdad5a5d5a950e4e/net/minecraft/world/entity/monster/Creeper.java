...
public class Creeper extends Monster {
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.entityData.set(DATA_IS_POWERED, pCompound.getBooleanOr("powered", false));
        this.maxSwell = pCompound.getShortOr("Fuse", (short)30);
        this.explosionRadius = pCompound.getByteOr("ExplosionRadius", (byte)3);
        if (pCompound.getBooleanOr("ignited", false)) {
            this.ignite();
        }
    }
    ...
    public float getSwelling(float pPartialTicks) {
        return Mth.lerp(pPartialTicks, this.oldSwell, this.swell) / (this.maxSwell - 2);
    }
