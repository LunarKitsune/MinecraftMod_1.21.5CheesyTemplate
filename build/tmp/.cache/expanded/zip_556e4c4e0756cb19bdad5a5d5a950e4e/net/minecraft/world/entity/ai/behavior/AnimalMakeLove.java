...
public class AnimalMakeLove extends Behavior<Animal> {
    ...
    protected void start(ServerLevel pLevel, Animal pEntity, long pGameTime) {
        ...
        this.spawnChildAtTime = pGameTime + i;
    }
    ...
    private Optional<? extends Animal> findValidBreedPartner(Animal pAnimal) {
        return pAnimal.getBrain()
            .getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
            .get()
            .findClosest(
                p_390544_ -> p_390544_.getType() == this.partnerType && p_390544_ instanceof Animal animal && pAnimal.canMate(animal) && !animal.isPanicking()
            )
