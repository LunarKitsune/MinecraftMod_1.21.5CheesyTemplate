...
public class DefaultAttributes {
    ...
    public static AttributeSupplier getSupplier(EntityType<? extends LivingEntity> pLivingEntity) {
        AttributeSupplier supplier = net.minecraftforge.common.ForgeHooks.getAttributesView().get(pLivingEntity);
        return supplier != null ? supplier : SUPPLIERS.get(pLivingEntity);
    }

    public static boolean hasSupplier(EntityType<?> pEntityType) {
        return SUPPLIERS.containsKey(pEntityType) || net.minecraftforge.common.ForgeHooks.getAttributesView().containsKey(pEntityType);
    }
    ...
    public static void validate() {
        BuiltInRegistries.ENTITY_TYPE
            ...
            .forEach(p_326801_ -> Util.logAndPauseIfInIde("Entity " + p_326801_ + " has no attributes"));
    }
}
