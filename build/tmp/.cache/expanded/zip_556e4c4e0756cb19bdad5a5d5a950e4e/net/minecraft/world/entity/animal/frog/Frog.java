...
public class Frog extends Animal {
    ...
    private void setVariant(Holder<FrogVariant> pVariant) {
    ...
    public static boolean canEat(LivingEntity pEntity) {
        return pEntity instanceof Slime slime && slime.getSize() != 1 ? false : pEntity.getType().is(EntityTypeTags.FROG_FOOD);
    }
