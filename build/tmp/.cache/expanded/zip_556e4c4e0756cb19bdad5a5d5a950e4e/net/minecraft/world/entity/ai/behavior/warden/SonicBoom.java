...
public class SonicBoom extends Behavior<Warden> {
    ...
    protected void tick(ServerLevel p_217724_, Warden p_217725_, long p_217726_) {
        p_217725_.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).ifPresent(p_390626_ -> p_217725_.getLookControl().setLookAt(p_390626_.position()));
    ...
    public static void setCooldown(LivingEntity pEntity, int pCooldown) {
        pEntity.getBrain().setMemoryWithExpiry(MemoryModuleType.SONIC_BOOM_COOLDOWN, Unit.INSTANCE, pCooldown);
    }
}