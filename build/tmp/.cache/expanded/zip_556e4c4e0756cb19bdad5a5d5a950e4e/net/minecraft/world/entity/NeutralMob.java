...
public interface NeutralMob {
    ...
    default void addPersistentAngerSaveData(CompoundTag pNbt) {
        ...
        pNbt.storeNullable("AngryAt", UUIDUtil.CODEC, this.getPersistentAngerTarget());
    }

    default void readPersistentAngerSaveData(Level pLevel, CompoundTag pTag) {
        this.setRemainingPersistentAngerTime(pTag.getIntOr("AngerTime", 0));
        if (pLevel instanceof ServerLevel serverlevel) {
            UUID $$4 = pTag.read("AngryAt", UUIDUtil.CODEC).orElse(null);
