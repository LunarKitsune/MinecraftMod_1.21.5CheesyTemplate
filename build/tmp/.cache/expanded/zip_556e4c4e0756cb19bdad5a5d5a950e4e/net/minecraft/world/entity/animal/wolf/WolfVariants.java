...
public class WolfVariants {
    ...
    public static Optional<? extends Holder<WolfVariant>> selectVariantToSpawn(RandomSource pRandom, RegistryAccess pRegistryAccess, SpawnContext pContext) {
        return PriorityProvider.pick(pRegistryAccess.lookupOrThrow(Registries.WOLF_VARIANT).listElements(), Holder::value, pRandom, pContext);
    }
