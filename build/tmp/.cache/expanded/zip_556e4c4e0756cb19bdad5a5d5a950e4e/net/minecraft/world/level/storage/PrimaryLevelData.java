...
public class PrimaryLevelData implements ServerLevelData, WorldData {
    ...
    private void setTagData(RegistryAccess pRegistry, CompoundTag pNbt, @Nullable CompoundTag pPlayerNBT) {
        ...
        pNbt.store("DragonFight", EndDragonFight.Data.CODEC, this.endDragonFightData);
        if (pPlayerNBT != null) {
            pNbt.put("Player", pPlayerNBT);
        }

        pNbt.store(WorldDataConfiguration.MAP_CODEC, this.settings.getDataConfiguration());
        ...
        pNbt.storeNullable("WanderingTraderId", UUIDUtil.CODEC, this.wanderingTraderId);
