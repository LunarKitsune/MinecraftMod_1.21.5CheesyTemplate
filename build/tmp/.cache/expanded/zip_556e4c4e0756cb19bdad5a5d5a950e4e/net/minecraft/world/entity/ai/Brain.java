...
public class Brain<E extends LivingEntity> {
    ...
    public void addActivityWithConditions(
        Activity pActivity,
        int pPriorityStart,
        ImmutableList<? extends BehaviorControl<? super E>> pTasks,
        Set<Pair<MemoryModuleType<?>, MemoryStatus>> pMemoryStatuses
    ) {
        this.addActivityWithConditions(pActivity, this.createPriorityPairs(pPriorityStart, pTasks), pMemoryStatuses);
    }
