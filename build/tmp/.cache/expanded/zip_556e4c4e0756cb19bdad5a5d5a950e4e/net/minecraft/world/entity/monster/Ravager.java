...
public class Ravager extends Raider {
    ...
    private static final Predicate<LivingEntity> ROAR_TARGET_ON_CLIENT = p_390681_ -> !(p_390681_ instanceof Ravager) && p_390681_.isAlive() && p_390681_.isLocalInstanceAuthoritative();
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.attackTick = pCompound.getIntOr("AttackTick", 0);
        this.stunnedTick = pCompound.getIntOr("StunTick", 0);
        this.roarTick = pCompound.getIntOr("RoarTick", 0);
    }
