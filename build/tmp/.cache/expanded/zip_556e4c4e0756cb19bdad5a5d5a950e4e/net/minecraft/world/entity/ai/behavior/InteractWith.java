...
public class InteractWith {
    public static <T extends LivingEntity> BehaviorControl<LivingEntity> of(
        ...
        return of(pType, pInteractionRange, p_23287_ -> true, p_23285_ -> true, pInteractMemory, pSpeedModifier, pMaxDist);
    }

    public static <E extends LivingEntity, T extends LivingEntity> BehaviorControl<E> of(
        EntityType<? extends T> pType,
        int pInteractionRange,
        Predicate<E> pSelfFilter,
        Predicate<T> pTargetFilter,
        MemoryModuleType<T> pMemory,
        float pSpeedModifier,
        int pMaxDist
    ) {
        int i = pInteractionRange * pInteractionRange;
        Predicate<LivingEntity> predicate = p_390557_ -> pType.equals(p_390557_.getType()) && pTargetFilter.test((T)p_390557_);
        return BehaviorBuilder.create(
            p_258426_ -> p_258426_.group(
                    p_258426_.registered(pMemory),
