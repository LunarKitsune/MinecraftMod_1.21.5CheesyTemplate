...
public class LootPool {
    ...
    LootPool(List<LootPoolEntryContainer> pEntries, List<LootItemCondition> pConditions, List<LootItemFunction> pFunctions, NumberProvider pRolls, NumberProvider pBonusRolls) {
        this(pEntries, pConditions, pFunctions, pRolls, pBonusRolls, java.util.Optional.empty(), java.util.Optional.empty());
    }
