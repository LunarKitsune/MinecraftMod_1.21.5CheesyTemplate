...
public class Armadillo extends Animal {
    ...
    public void addAdditionalSaveData(CompoundTag p_328280_) {
        ...
        p_328280_.store("state", Armadillo.ArmadilloState.CODEC, this.getState());
    ...
    public void readAdditionalSaveData(CompoundTag p_329448_) {
        ...
        this.switchToState(p_329448_.read("state", Armadillo.ArmadilloState.CODEC).orElse(Armadillo.ArmadilloState.IDLE));
        p_329448_.getInt("scute_time").ifPresent(p_394978_ -> this.scuteTime = p_394978_);
    }
