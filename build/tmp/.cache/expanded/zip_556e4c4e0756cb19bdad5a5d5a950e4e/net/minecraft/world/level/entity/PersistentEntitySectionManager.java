...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
    ...
    private boolean addEntity(T pEntity, boolean pWorldGenSpawned) {
        if (pEntity instanceof Entity entity && net.minecraftforge.event.ForgeEventFactory.onEntityJoinLevel(entity, entity.level(), pWorldGenSpawned)) {
            return false;
        }
    ...
    public boolean isTicking(ChunkPos pChunkPos) {
    ...
    class Callback implements EntityInLevelCallback {
        ...
        Callback(final T pEntity, final long pCurrentSectionKey, final EntitySection<T> pCurrentSection) {
            this.entity = pEntity;
            this.realEntity = pEntity instanceof Entity e ? e : null;
