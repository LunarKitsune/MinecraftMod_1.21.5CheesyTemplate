...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(
            (p_390665_, p_390666_) -> !p_390665_.getType().equals(EntityType.GOAT)
                && (p_390666_.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) || !p_390665_.getType().equals(EntityType.ARMOR_STAND))
                && p_390666_.getWorldBorder().isWithinBounds(p_390665_.getBoundingBox())
        );
            ...
            ImmutableList.of(
                Pair.of(
                    ...
                    new RamTarget(
                        ...
                        3.0F,
                        p_390664_ -> p_390664_.isBaby() ? 1.0 : 2.5,
