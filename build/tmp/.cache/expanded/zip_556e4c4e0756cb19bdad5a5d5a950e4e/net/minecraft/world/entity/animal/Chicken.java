...
public class Chicken extends Animal {
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.isChickenJockey = pCompound.getBooleanOr("IsChickenJockey", false);
        pCompound.getInt("EggLayTime").ifPresent(p_390644_ -> this.eggTime = p_390644_);
        VariantUtils.readVariant(pCompound, this.registryAccess(), Registries.CHICKEN_VARIANT).ifPresent(this::setVariant);
    }
    ...
    public void setVariant(Holder<ChickenVariant> pVariant) {
