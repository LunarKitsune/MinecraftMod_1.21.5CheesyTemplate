    ...
    public static OneShot<AgeableMob> create(UniformInt pFollowRange, Function<LivingEntity, Float> pSpeedModifier) {
        return BehaviorBuilder.create(
            p_258331_ -> p_258331_.group(
                ...
                .apply(p_258331_, (p_258317_, p_258318_, p_258319_) -> (p_258326_, p_258327_, p_258328_) -> {
                    if (!p_258327_.isBaby()) {
                        return false;
                    } else {
                        AgeableMob ageablemob = p_258331_.get(p_258317_);
                        if (p_258327_.closerThan(ageablemob, pFollowRange.getMaxValue() + 1) && !p_258327_.closerThan(ageablemob, pFollowRange.getMinValue())) {
