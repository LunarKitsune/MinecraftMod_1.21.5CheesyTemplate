...
public class AABB {
    ...
    public AABB(BlockPos pPos) {
        this(pPos.getX(), pPos.getY(), pPos.getZ(), pPos.getX() + 1, pPos.getY() + 1, pPos.getZ() + 1);
    }
    ...
    public static AABB of(BoundingBox pMutableBox) {
        return new AABB(
            pMutableBox.minX(), pMutableBox.minY(), pMutableBox.minZ(), pMutableBox.maxX() + 1, pMutableBox.maxY() + 1, pMutableBox.maxZ() + 1
        );
    }
    ...
    public static class Builder {
        ...
        public void include(Vector3fc pPos) {
            this.minX = Math.min(this.minX, pPos.x());
            this.minY = Math.min(this.minY, pPos.y());
            this.minZ = Math.min(this.minZ, pPos.z());
            this.maxX = Math.max(this.maxX, pPos.x());
            this.maxY = Math.max(this.maxY, pPos.y());
            this.maxZ = Math.max(this.maxZ, pPos.z());
        }
