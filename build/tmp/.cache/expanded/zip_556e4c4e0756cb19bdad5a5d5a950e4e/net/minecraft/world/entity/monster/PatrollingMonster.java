...
public abstract class PatrollingMonster extends Monster {
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.storeNullable("patrol_target", BlockPos.CODEC, this.patrolTarget);
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.patrolTarget = pCompound.read("patrol_target", BlockPos.CODEC).orElse(null);
        this.patrolLeader = pCompound.getBooleanOr("PatrolLeader", false);
        this.patrolling = pCompound.getBooleanOr("Patrolling", false);
    }
