...
public class AxeItem extends Item {
    ...
    public AxeItem(ToolMaterial pMaterial, float pAttackDamage, float pAttackSpeed, Item.Properties pProperties) {
        super(pProperties.axe(pMaterial, pAttackDamage, pAttackSpeed));
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (playerHasBlockingItemUseIntent(pContext)) {
    ...
    private static boolean playerHasBlockingItemUseIntent(UseOnContext pContext) {
        Player player = pContext.getPlayer();
        return pContext.getHand().equals(InteractionHand.MAIN_HAND) && player.getOffhandItem().has(DataComponents.BLOCKS_ATTACKS) && !player.isSecondaryUseActive();
    }
