...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.store("FireworksItem", ItemStack.CODEC, registryops, this.getItem());
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.life = pCompound.getIntOr("Life", 0);
        this.lifetime = pCompound.getIntOr("LifeTime", 0);
        RegistryOps<Tag> registryops = this.registryAccess().createSerializationContext(NbtOps.INSTANCE);
        this.entityData.set(DATA_ID_FIREWORKS_ITEM, pCompound.read("FireworksItem", ItemStack.CODEC, registryops).orElse(getDefaultItem()));
        this.entityData.set(DATA_SHOT_AT_ANGLE, pCompound.getBooleanOr("ShotAtAngle", false));
    }
