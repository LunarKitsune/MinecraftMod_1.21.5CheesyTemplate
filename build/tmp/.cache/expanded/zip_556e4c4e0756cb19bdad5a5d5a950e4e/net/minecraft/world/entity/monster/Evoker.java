...
public class Evoker extends SpellcasterIllager {
    ...
    class EvokerAttackSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        private void createSpellEntity(double pX, double pZ, double pMinY, double pMaxY, float pYRot, int pWarmupDelay) {
            ...
            if (flag) {
                Evoker.this.level()
                    .addFreshEntity(new EvokerFangs(Evoker.this.level(), pX, blockpos.getY() + d0, pZ, pYRot, pWarmupDelay, Evoker.this));
                Evoker.this.level()
                    .gameEvent(GameEvent.ENTITY_PLACE, new Vec3(pX, blockpos.getY() + d0, pZ), GameEvent.Context.of(Evoker.this));
            }
        }
