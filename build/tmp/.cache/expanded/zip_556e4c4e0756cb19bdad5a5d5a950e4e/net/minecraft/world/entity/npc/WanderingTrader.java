...
public class WanderingTrader extends AbstractVillager implements Consumable.OverrideConsumeSound {
        ...
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_390732_ -> this.level().isDarkOutside() && !p_390732_.isInvisible()
                )
            );
        this.goalSelector
            .addGoal(
                0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, p_390731_ -> this.level().isBrightOutside() && p_390731_.isInvisible())
            );
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.storeNullable("wander_target", BlockPos.CODEC, this.wanderTarget);
    }

    @Override
    public void readAdditionalSaveData(CompoundTag pCompound) {
        super.readAdditionalSaveData(pCompound);
        this.despawnDelay = pCompound.getIntOr("DespawnDelay", 0);
        this.wanderTarget = pCompound.read("wander_target", BlockPos.CODEC).orElse(null);
