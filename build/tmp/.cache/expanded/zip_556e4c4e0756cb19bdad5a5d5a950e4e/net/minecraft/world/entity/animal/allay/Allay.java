...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
    ...
    public void addAdditionalSaveData(CompoundTag p_218367_) {
        ...
        p_218367_.store("listener", VibrationSystem.Data.CODEC, registryops, this.vibrationData);
    ...
    public void readAdditionalSaveData(CompoundTag p_218350_) {
        ...
        RegistryOps<Tag> registryops = this.registryAccess().createSerializationContext(NbtOps.INSTANCE);
        this.vibrationData = p_218350_.read("listener", VibrationSystem.Data.CODEC, registryops).orElseGet(VibrationSystem.Data::new);
        this.setDuplicationCooldown(p_218350_.getIntOr("DuplicationCooldown", 0));
    }
    ...
    private void setDuplicationCooldown(long pDuplicationCooldown) {
        this.duplicationCooldown = pDuplicationCooldown;
        this.entityData.set(DATA_CAN_DUPLICATE, pDuplicationCooldown == 0L);
    }
