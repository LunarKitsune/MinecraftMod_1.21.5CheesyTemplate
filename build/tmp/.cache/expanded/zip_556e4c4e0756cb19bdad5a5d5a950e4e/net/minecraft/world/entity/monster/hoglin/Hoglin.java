...
public class Hoglin extends Animal implements Enemy, HoglinBase {
    ...
    private void finishConversion() {
        this.convertTo(
            ...
            p_390697_ -> {
                p_390697_.addEffect(new MobEffectInstance(MobEffects.NAUSEA, 200, 0));
                net.minecraftforge.event.ForgeEventFactory.onLivingConvert(this, p_390697_);
            }
        );
    }
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.putBoolean("IsImmuneToZombification", this.isImmuneToZombification());
        pCompound.putInt("TimeInOverworld", this.timeInOverworld);
        pCompound.putBoolean("CannotBeHunted", this.cannotBeHunted);
    }

    @Override
    public void readAdditionalSaveData(CompoundTag pCompound) {
        super.readAdditionalSaveData(pCompound);
        this.setImmuneToZombification(pCompound.getBooleanOr("IsImmuneToZombification", false));
        this.timeInOverworld = pCompound.getIntOr("TimeInOverworld", 0);
        this.setCannotBeHunted(pCompound.getBooleanOr("CannotBeHunted", false));
    }
