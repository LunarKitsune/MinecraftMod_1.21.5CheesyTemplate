                ...
                .apply(
                    ...
                    (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_375011_, p_375012_, p_375013_) -> {
                        p_375011_.getPoiManager()
                            ...
                            .filter(p_374999_ -> p_374999_.closerToCenterThan(p_375012_.position(), pCloseEnoughDist))
                            .or(
                                () -> p_375011_.getPoiManager()
                                    .getRandom(
                            ...
                            .ifPresent(p_390570_ -> {
                                ...
                                if (!p_390570_.closerToCenterThan(p_375012_.position(), pCloseEnoughDist)) {
                                    p_258484_.set(new WalkTarget(p_390570_, pSpeedModifier, pCloseEnoughDist));
                                }
                            });
                        return true;
                    }
