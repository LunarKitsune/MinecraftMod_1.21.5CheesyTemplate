...
public class NoiseRouterData {
    ...
    private static ResourceKey<DensityFunction> createKey(String pLocation) {
        return ResourceKey.create(Registries.DENSITY_FUNCTION, ResourceLocation.withDefaultNamespace(pLocation));
    }
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> pContext) {
        ...
        pContext.register(Y, DensityFunctions.yClampedGradient(i, j, i, j));
        DensityFunction densityfunction = registerAndWrap(
            pContext, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(holdergetter.getOrThrow(Noises.SHIFT))))
        );
        DensityFunction densityfunction1 = registerAndWrap(
            pContext, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(holdergetter.getOrThrow(Noises.SHIFT))))
        );
        pContext.register(BASE_3D_NOISE_OVERWORLD, BlendedNoise.createUnseeded(0.25, 0.125, 80.0, 160.0, 8.0));
        pContext.register(BASE_3D_NOISE_NETHER, BlendedNoise.createUnseeded(0.25, 0.375, 80.0, 60.0, 8.0));
        pContext.register(BASE_3D_NOISE_END, BlendedNoise.createUnseeded(0.25, 0.25, 80.0, 160.0, 4.0));
        Holder<DensityFunction> holder = pContext.register(
            CONTINENTS,
        ...
        Holder<DensityFunction> holder1 = pContext.register(
            EROSION,
        ...
        Holder<DensityFunction> holder2 = pContext.register(
            CONTINENTS_LARGE,
        ...
        Holder<DensityFunction> holder3 = pContext.register(
            EROSION_LARGE,
        ...
        pContext.register(SPAGHETTI_2D_THICKNESS_MODULATOR, DensityFunctions.cacheOnce(DensityFunctions.mappedNoise(holdergetter.getOrThrow(Noises.SPAGHETTI_2D_THICKNESS), 2.0, 1.0, -0.6, -1.3)));
    ...
    private static void registerTerrainNoises(
        BootstrapContext<DensityFunction> pContext,
        HolderGetter<DensityFunction> pDensityFunctionRegistry,
        DensityFunction pJaggedNoise,
        Holder<DensityFunction> pContinentalness,
        Holder<DensityFunction> pErosion,
        ResourceKey<DensityFunction> pOffsetKey,
        ResourceKey<DensityFunction> pFactorKey,
        ResourceKey<DensityFunction> pJaggednessKey,
        ResourceKey<DensityFunction> pDepthKey,
        ResourceKey<DensityFunction> pSlopedCheeseKey,
        boolean pAmplified
    ) {
        DensityFunctions.Spline.Coordinate densityfunctions$spline$coordinate = new DensityFunctions.Spline.Coordinate(pContinentalness);
        DensityFunctions.Spline.Coordinate densityfunctions$spline$coordinate1 = new DensityFunctions.Spline.Coordinate(pErosion);
        DensityFunctions.Spline.Coordinate densityfunctions$spline$coordinate2 = new DensityFunctions.Spline.Coordinate(pDensityFunctionRegistry.getOrThrow(RIDGES));
        DensityFunctions.Spline.Coordinate densityfunctions$spline$coordinate3 = new DensityFunctions.Spline.Coordinate(pDensityFunctionRegistry.getOrThrow(RIDGES_FOLDED));
        DensityFunction densityfunction = registerAndWrap(
            pContext,
            pOffsetKey,
            splineWithBlending(
                DensityFunctions.add(
                    ...
                    DensityFunctions.spline(
                        TerrainProvider.overworldOffset(
                            densityfunctions$spline$coordinate, densityfunctions$spline$coordinate1, densityfunctions$spline$coordinate3, pAmplified
                        )
                    )
                ),
        ...
        DensityFunction densityfunction2 = registerAndWrap(
            pContext, pDepthKey, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityfunction)
        );
        ...
        pContext.register(pSlopedCheeseKey, DensityFunctions.add(densityfunction5, getFunction(pDensityFunctionRegistry, BASE_3D_NOISE_OVERWORLD)));
    }
    ...
    private static DensityFunction registerAndWrap(BootstrapContext<DensityFunction> pContext, ResourceKey<DensityFunction> pKey, DensityFunction pValue) {
        return new DensityFunctions.HolderHolder(pContext.register(pKey, pValue));
    }
    ...
    private static DensityFunction getFunction(HolderGetter<DensityFunction> pDensityFunctionRegistry, ResourceKey<DensityFunction> pKey) {
        return new DensityFunctions.HolderHolder(pDensityFunctionRegistry.getOrThrow(pKey));
    }

    private static DensityFunction peaksAndValleys(DensityFunction pDensityFunction) {
        return DensityFunctions.mul(
            DensityFunctions.add(
                DensityFunctions.add(pDensityFunction.abs(), DensityFunctions.constant(-0.6666666666666666)).abs(),
    ...
    public static float peaksAndValleys(float pWeirdness) {
        return -(Math.abs(Math.abs(pWeirdness) - 0.6666667F) - 0.33333334F) * 3.0F;
    }
    ...
    private static DensityFunction spaghettiRoughnessFunction(HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        ...
        DensityFunction densityfunction1 = DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.SPAGHETTI_ROUGHNESS_MODULATOR), 0.0, -0.1);
    ...
    private static DensityFunction entrances(HolderGetter<DensityFunction> pDensityFunctionRegistry, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        DensityFunction densityfunction = DensityFunctions.cacheOnce(DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.SPAGHETTI_3D_RARITY), 2.0, 1.0));
        DensityFunction densityfunction1 = DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.SPAGHETTI_3D_THICKNESS), -0.065, -0.088);
        DensityFunction densityfunction2 = DensityFunctions.weirdScaledSampler(
            densityfunction, pNoiseParameters.getOrThrow(Noises.SPAGHETTI_3D_1), DensityFunctions.WeirdScaledSampler.RarityValueMapper.TYPE1
        );
        DensityFunction densityfunction3 = DensityFunctions.weirdScaledSampler(
            densityfunction, pNoiseParameters.getOrThrow(Noises.SPAGHETTI_3D_2), DensityFunctions.WeirdScaledSampler.RarityValueMapper.TYPE1
        );
        DensityFunction densityfunction4 = DensityFunctions.add(DensityFunctions.max(densityfunction2, densityfunction3), densityfunction1)
            .clamp(-1.0, 1.0);
        DensityFunction densityfunction5 = getFunction(pDensityFunctionRegistry, SPAGHETTI_ROUGHNESS_FUNCTION);
        DensityFunction densityfunction6 = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.CAVE_ENTRANCE), 0.75, 0.5);
    ...
    private static DensityFunction noodle(HolderGetter<DensityFunction> pDensityFunctions, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        ...
        int j = -60;
        int k = 320;
        DensityFunction densityfunction1 = yLimitedInterpolatable(densityfunction, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.NOODLE), 1.0, 1.0), -60, 320, -1);
        DensityFunction densityfunction2 = yLimitedInterpolatable(
            densityfunction, DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.NOODLE_THICKNESS), 1.0, 1.0, -0.05, -0.1), -60, 320, 0
        );
        double d0 = 2.6666666666666665;
        DensityFunction densityfunction3 = yLimitedInterpolatable(
            densityfunction, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.NOODLE_RIDGE_A), 2.6666666666666665, 2.6666666666666665), -60, 320, 0
        );
        DensityFunction densityfunction4 = yLimitedInterpolatable(
            densityfunction, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.NOODLE_RIDGE_B), 2.6666666666666665, 2.6666666666666665), -60, 320, 0
        );
    ...
    private static DensityFunction pillars(HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        double d0 = 25.0;
        double d1 = 0.3;
        DensityFunction densityfunction = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.PILLAR), 25.0, 0.3);
        DensityFunction densityfunction1 = DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.PILLAR_RARENESS), 0.0, -2.0);
        DensityFunction densityfunction2 = DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.PILLAR_THICKNESS), 0.0, 1.1);
    ...
    private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> pDensityFunctionRegistry, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        DensityFunction densityfunction = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.SPAGHETTI_2D_MODULATOR), 2.0, 1.0);
        DensityFunction densityfunction1 = DensityFunctions.weirdScaledSampler(
            densityfunction, pNoiseParameters.getOrThrow(Noises.SPAGHETTI_2D), DensityFunctions.WeirdScaledSampler.RarityValueMapper.TYPE2
        );
        DensityFunction densityfunction2 = DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0, Math.floorDiv(-64, 8), 8.0);
        DensityFunction densityfunction3 = getFunction(pDensityFunctionRegistry, SPAGHETTI_2D_THICKNESS_MODULATOR);
    ...
    private static DensityFunction underground(
        HolderGetter<DensityFunction> pDensityFunctionRegistry, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters, DensityFunction pSlopedCheese
    ) {
        DensityFunction densityfunction = getFunction(pDensityFunctionRegistry, SPAGHETTI_2D);
        DensityFunction densityfunction1 = getFunction(pDensityFunctionRegistry, SPAGHETTI_ROUGHNESS_FUNCTION);
        ...
        DensityFunction densityfunction5 = DensityFunctions.add(
            ...
            DensityFunctions.add(DensityFunctions.constant(1.5), DensityFunctions.mul(DensityFunctions.constant(-0.64), pSlopedCheese))
                .clamp(0.0, 0.5)
        );
        DensityFunction densityfunction6 = DensityFunctions.add(densityfunction3, densityfunction5);
        DensityFunction densityfunction7 = DensityFunctions.min(
            DensityFunctions.min(densityfunction6, getFunction(pDensityFunctionRegistry, ENTRANCES)), DensityFunctions.add(densityfunction, densityfunction1)
        );
        DensityFunction densityfunction8 = getFunction(pDensityFunctionRegistry, PILLARS);
    ...
    protected static NoiseRouter overworld(
        HolderGetter<DensityFunction> pDensityFunctionRegistry, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters, boolean pLarge, boolean pAmplified
    ) {
        DensityFunction densityfunction = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.AQUIFER_BARRIER), 0.5);
        DensityFunction densityfunction1 = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.AQUIFER_FLUID_LEVEL_FLOODEDNESS), 0.67);
        DensityFunction densityfunction2 = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.AQUIFER_FLUID_LEVEL_SPREAD), 0.7142857142857143);
        DensityFunction densityfunction3 = DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.AQUIFER_LAVA));
        DensityFunction densityfunction4 = getFunction(pDensityFunctionRegistry, SHIFT_X);
        DensityFunction densityfunction5 = getFunction(pDensityFunctionRegistry, SHIFT_Z);
        ...
        DensityFunction densityfunction8 = getFunction(pDensityFunctionRegistry, pLarge ? FACTOR_LARGE : (pAmplified ? FACTOR_AMPLIFIED : FACTOR));
        DensityFunction densityfunction9 = getFunction(pDensityFunctionRegistry, pLarge ? DEPTH_LARGE : (pAmplified ? DEPTH_AMPLIFIED : DEPTH));
        DensityFunction densityfunction10 = noiseGradientDensity(DensityFunctions.cache2d(densityfunction8), densityfunction9);
        DensityFunction densityfunction11 = getFunction(pDensityFunctionRegistry, pLarge ? SLOPED_CHEESE_LARGE : (pAmplified ? SLOPED_CHEESE_AMPLIFIED : SLOPED_CHEESE));
        DensityFunction densityfunction12 = DensityFunctions.min(
            densityfunction11, DensityFunctions.mul(DensityFunctions.constant(5.0), getFunction(pDensityFunctionRegistry, ENTRANCES))
        );
        DensityFunction densityfunction13 = DensityFunctions.rangeChoice(
            densityfunction11, -1000000.0, 1.5625, densityfunction12, underground(pDensityFunctionRegistry, pNoiseParameters, densityfunction11)
        );
        DensityFunction densityfunction14 = DensityFunctions.min(postProcess(slideOverworld(pAmplified, densityfunction13)), getFunction(pDensityFunctionRegistry, NOODLE));
        DensityFunction densityfunction15 = getFunction(pDensityFunctionRegistry, Y);
        ...
        DensityFunction densityfunction16 = yLimitedInterpolatable(densityfunction15, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), i, j, 0);
        float f = 4.0F;
        DensityFunction densityfunction17 = yLimitedInterpolatable(densityfunction15, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), i, j, 0)
            .abs();
        DensityFunction densityfunction18 = yLimitedInterpolatable(densityfunction15, DensityFunctions.noise(pNoiseParameters.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), i, j, 0)
            .abs();
        ...
        return new NoiseRouter(
            ...
            densityfunction6,
            densityfunction7,
            getFunction(pDensityFunctionRegistry, pLarge ? CONTINENTS_LARGE : CONTINENTS),
            getFunction(pDensityFunctionRegistry, pLarge ? EROSION_LARGE : EROSION),
            densityfunction9,
            getFunction(pDensityFunctionRegistry, RIDGES),
            slideOverworld(pAmplified, DensityFunctions.add(densityfunction10, DensityFunctions.constant(-0.703125)).clamp(-64.0, 64.0)),
            densityfunction14,
            densityfunction16,
            densityfunction19,
            densityfunction20
    ...
    private static NoiseRouter noNewCaves(
        HolderGetter<DensityFunction> pDensityFunctions, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters, DensityFunction pPostProccessor
    ) {
        ...
        DensityFunction densityfunction4 = postProcess(pPostProccessor);
        return new NoiseRouter(
    ...
    private static DensityFunction slideNetherLike(HolderGetter<DensityFunction> pDensityFunctions, int pMinY, int pHeight) {
        return slide(getFunction(pDensityFunctions, BASE_3D_NOISE_NETHER), pMinY, pHeight, 24, 0, 0.9375, -8, 24, 2.5);
    }

    private static DensityFunction slideEndLike(DensityFunction pDensityFunction, int pMinY, int pHeight) {
        return slide(pDensityFunction, pMinY, pHeight, 72, -184, -23.4375, 4, 32, -0.234375);
    }
    ...
    private static DensityFunction yLimitedInterpolatable(DensityFunction pInput, DensityFunction pWhenInRange, int pMinY, int pMaxY, int pWhenOutOfRange) {
        return DensityFunctions.interpolated(DensityFunctions.rangeChoice(pInput, pMinY, pMaxY + 1, pWhenInRange, DensityFunctions.constant(pWhenOutOfRange)));
    }

    private static DensityFunction slide(
        DensityFunction pInput, int pMinY, int pHeight, int pTopStartOffset, int pTopEndOffset, double pTopDelta, int pBottomStartOffset, int pBottomEndOffset, double pBottomDelta
    ) {
        DensityFunction densityfunction1 = DensityFunctions.yClampedGradient(pMinY + pHeight - pTopStartOffset, pMinY + pHeight - pTopEndOffset, 1.0, 0.0);
        DensityFunction $$9 = DensityFunctions.lerp(densityfunction1, pTopDelta, pInput);
        DensityFunction densityfunction2 = DensityFunctions.yClampedGradient(pMinY + pBottomStartOffset, pMinY + pBottomEndOffset, 0.0, 1.0);
        return DensityFunctions.lerp(densityfunction2, pBottomDelta, $$9);
    }
