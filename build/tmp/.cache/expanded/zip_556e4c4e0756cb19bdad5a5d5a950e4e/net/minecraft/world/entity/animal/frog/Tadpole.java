...
public class Tadpole extends AbstractFish {
    ...
    private void ageUp() {
        if (this.level() instanceof ServerLevel serverlevel) {
            this.convertTo(EntityType.FROG, ConversionParams.single(this, false, false), p_390663_ -> {
                p_390663_.finalizeSpawn(serverlevel, this.level().getCurrentDifficultyAt(p_390663_.blockPosition()), EntitySpawnReason.CONVERSION, null);
                p_390663_.setPersistenceRequired();
                p_390663_.fudgePositionAfterSizeChange(this.getDimensions(this.getPose()));
