...
public class MobSpawnSettings {
    ...
    MobSpawnSettings(
        float pCreatureGenerationProbability, Map<MobCategory, WeightedList<MobSpawnSettings.SpawnerData>> pSpawners, Map<EntityType<?>, MobSpawnSettings.MobSpawnCost> pMobSpawnCosts
    ) {
    ...
    public WeightedList<MobSpawnSettings.SpawnerData> getMobs(MobCategory pCategory) {
    ...
    public static class Builder {
        ...
        public MobSpawnSettings.Builder addSpawn(MobCategory pCategory, int pWeight, MobSpawnSettings.SpawnerData pSpawnerData) {
            this.spawners.get(pCategory).add(pSpawnerData, pWeight);
            return this;
        }
