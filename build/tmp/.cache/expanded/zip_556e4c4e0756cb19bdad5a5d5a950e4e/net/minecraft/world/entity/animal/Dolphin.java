...
public class Dolphin extends AgeableWaterCreature {
    ...
    public static final Predicate<ItemEntity> ALLOWED_ITEMS = p_390645_ -> !p_390645_.hasPickUpDelay() && p_390645_.isAlive() && p_390645_.isInWater();
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.setGotFish(pCompound.getBooleanOr("GotFish", false));
        this.setMoisntessLevel(pCompound.getIntOr("Moistness", 2400));
    }
